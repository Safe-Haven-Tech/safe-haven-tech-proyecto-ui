...
const WelcomeSection = React.memo(() => {
  return (
    <div className="col-md-6 d-none d-md-flex align-items-center justify-content-center">
      <div className="text-center px-4 py-5" style={styles.welcomeSection}>
        <h1 className="display-6 fw-bold mb-3" style={styles.welcomeTitle}>
          ¡Bienvenido a SafeHaven!
        </h1>
        <p className="lead mb-4" style={styles.welcomeText}>
        ...
        <div className="d-flex justify-content-center gap-4">
          <div className="text-center">
            ...
            <small className="text-white fw-semibold">Apoyo</small>
          </div>
          <div className="text-center">
            <div
              className="d-flex align-items-center justify-content-center mx-auto mb-2"
            ...
            <small className="text-white fw-semibold">Comunidad</small>
          </div>
          <div className="text-center">
            <div
              className="d-flex align-items-center justify-content-center mx-auto mb-2"
            ...
            <small className="text-white fw-semibold">Recursos</small>
          </div>
        </div>
      </div>
    </div>
      ...
      >
        <div className="row justify-content-between align-items-center min-vh-100 g-0">
          ...
          <div className="col-lg-5 col-xl-4 p-0">
            <div className="p-5" style={styles.formContainer}>
              <Suspense
                fallback={

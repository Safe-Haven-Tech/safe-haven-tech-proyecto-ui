  ...
  const miniBoxes = [
    {
      ...
      description:
        'Perfiles revisados con formación y experiencia en violencia en relaciones afectivas.',
    },
    {
      icon: BookIcon,
      title: 'Derivaciones y recursos',
      description:
        'Acceso a redes legales, sociales y servicios complementarios para acompañamiento integral.',
    },
    {
      icon: LockIcon,
      title: 'Confidencialidad y seguridad',
      description:
        'Comunicación y datos protegidos; opciones para contacto seguro y manejo privado de información.',
    },
  ];
      ...
      <div className={styles.mainContainer}>
        ...
        <div className={styles.imageSpace} aria-hidden={false}>
          <div
            ...
            role="region"
            aria-label="Invitación a profesionales"
          >
            <h3 className={styles.applyTitle}>
              ¿Eres profesional? Únete a nuestra comunidad
            </h3>
            <p className={styles.applyText}>
              Si trabajas en apoyo a personas que han vivido violencia en
              relaciones afectivas, puedes postular para formar parte de nuestro
              directorio verificado.
            </p>
            <div className={styles.applyActions}>
              <a href="/postular" className={styles.applyButton}>
                Postular ahora
              </a>
            </div>
          </div>

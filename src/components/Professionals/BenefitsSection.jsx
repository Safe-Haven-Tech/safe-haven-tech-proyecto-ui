...
const IconSupport = () => (
  <svg viewBox="0 0 24 24" width="40" height="40" fill="none" aria-hidden>
    <path
      d="M12 2a7 7 0 00-7 7v3a7 7 0 007 7 7 7 0 007-7V9a7 7 0 00-7-7z"
      fill="#efe6fb"
    />
    <path
...
const items = [
  ...
  },
  {
    ...
    description:
      'Acceso a redes y servicios complementarios (legal, social, protección).',
  },
  {
    icon: <IconShield />,
    title: 'Confidencialidad priorizada',
    description:
      'Información y contacto manejados con criterios de seguridad y privacidad.',
  },
  {
    icon: <IconClock />,
    title: 'Disponibilidad flexible',
    description:
      'Modalidades presencial y online; horarios adaptables según necesidad.',
  },
];
...
export default function BenefitsSection() {
  return (
    <section
      className={`container ${styles.benefitsSection}`}
      aria-labelledby="professionals-benefits-title"
    >
      ...
      <p className={styles.sectionSubtitle}>
        Encuentra apoyo con enfoque en seguridad emocional y medidas prácticas
        para tu bienestar.
      </p>
      ...
      <div className={styles.benefitsGrid}>
        {items.map((item, idx) => (
          <div
            key={idx}
            className={`card ${styles.benefitCard}`}
            role="article"
